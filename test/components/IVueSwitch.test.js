...
describe('IvueListItem', function () {
    ...
    it('should render the switch emboss', async () => {
        const wrapper = mount({
            template: `
                    <IvueSwitch class="red-accent-4" :value="true" emboss></IvueSwitch>
              `,
            components: {
                IvueSwitch
            }
        ...
        expect(wrapper.classes('ivue-switch-emboss--wrapper')).to.be.equal(true);
    });
});
